...
public class Constants {
	public static final String NAME_WEB_INF_ROOT = "//WEB-INF";
	...
	public static final String KEY_EDIT_CHECKBOX = "checkEditTask";
	public static final String KEY_CONTENT_TASK = "contentTask";
	public static final String KEY_DATE_TASK = "dateTask";
    ...
    public static final String JUMP_TASK_CONTROLLER = "/task";
    ...
    public static final String LOGIN_EXISTS_ERROR = "This login is already taken. Try again.";
